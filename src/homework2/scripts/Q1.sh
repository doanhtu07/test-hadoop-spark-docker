source /src/homework2/scripts/Q1-clean.sh
...
hadoop jar /src/homework2/target/homework2-1.0.0.jar com.homework2.Q1 $HDFS_CITY_PATH $HDFS_COUNTRY_PATH /output/hw2/Q1/

hdfs dfs -get /output/hw2/Q1/part-r-00000 /src/io/hw2/Q1-output.txt
