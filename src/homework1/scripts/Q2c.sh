...
hadoop jar /src/homework1/target/homework1-1.0.0.jar com.homework1.Q2c $HDFS_CITY_PATH /intermediate/hw1/Q2c/ /output/hw1/Q2c/

hdfs dfs -get /intermediate/hw1/Q2c/part-r-00000 /src/io/hw1/Q2c-intermediate.txt
