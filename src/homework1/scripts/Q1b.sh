source /src/homework1/scripts/Q1b-clean.sh
...
hadoop jar /src/homework1/target/homework1-1.0.0.jar com.homework1.Q1b $HDFS_PATH /output/hw1/Q1b/

hdfs dfs -get /output/hw1/Q1b/part-r-00000 /src/io/hw1/Q1b-output.txt
