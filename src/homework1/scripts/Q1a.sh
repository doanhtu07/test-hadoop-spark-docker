source /src/homework1/scripts/Q1a-clean.sh
...
hadoop jar /src/homework1/target/homework1-1.0.0.jar com.homework1.Q1a $HDFS_PATH /output/hw1/Q1a/

hdfs dfs -get /output/hw1/Q1a/part-r-00000 /src/io/hw1/Q1a-output.txt
